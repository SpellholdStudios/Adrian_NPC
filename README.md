...
Run **`setup-adrian.exe`** in your game folder to reinstall, un-install or otherwise change the components settings.
...
Run **`setup-adrian.command`** in your game folder to reinstall, un-install or otherwise change the components settings.
...
To install, run **`WeInstall setup-adrian`** in your game folder. Then run **`wine BGMain.exe`** and start playing.
...
- **Gender:** Adrian will only romance a female protagonist.
